...
const ALGOLIA_APP_ID = import.meta.env.VITE_REACT_APP_ALGOLIA_APP_ID;
const ALGOLIA_SEARCH_KEY = import.meta.env.VITE_REACT_APP_ALGOLIA_SEARCH_KEY;
const ALGOLIA_INDEX_NAME = import.meta.env.VITE_REACT_APP_ALGOLIA_INDEX_NAME;
