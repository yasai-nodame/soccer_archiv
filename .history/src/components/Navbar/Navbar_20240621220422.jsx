...
const Navbar = ({ matches }) => {
    ...
    const fillterdMatches = matches.filter(match => match.title.toLowerCase().includes(searchQuery.toLowerCase()));
    ...
    return (
        <div className={`navbar ${isScrolled ? 'hide' : ''}`}>
            ...
            <div className="search-box">
                <input type="text" placeholder="Search..." value={searchQuery} onChange={setSearchQuery(e.target.value)} />
                <ul>
                    {fillterdMatches.map(match => (
