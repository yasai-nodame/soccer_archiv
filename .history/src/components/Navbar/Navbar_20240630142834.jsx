...
const ALGOLIA_APP_ID = process.env.VITE_REACT_APP_FIREBASE_ALGOLIA_APP_ID;
const ALGOLIA_SEARCH_KEY = process.env.VITE_REACT_APP_ALGOLIA_SEARCH_KEY;
const ALGOLIA_INDEX_NAME = process.env.VITE_REACT_APP_FIREBASE_ALGOLIA_INDEX_NAME;
