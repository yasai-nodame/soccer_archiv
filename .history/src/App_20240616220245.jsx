...
const App = () => {
  ...
  const matches = [
    {id:1, date: '2024-6-11', category: 'プレミアリーグ', title: '第1節 チェルシー×アーセナル', thumbnail: soccer},
    {id:2, date: '2024-6-11', category: 'プレミアリーグ', title: '第1節 フラム×リヴァプール', thumbnail: soccer},
    {id:3, date: '2024-6-12', category: 'プレミアリーグ', title: '第1節 マンチェスターシティ×エヴァートン', thumbnail:soccer},
    {id:4, date: '2024-6-12', category: 'FAカップ', title: 'レスターシティ×トッテナム', thumbnail:soccer},
    {id:5, date: '2024-6-13', category: 'プレミアリーグ', title: '第1節 ウルブス×マンチェスターユナイテッド', thumbnail:soccer},
