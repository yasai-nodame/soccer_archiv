...
const App = () => {
  ...
  const matches = [
    ...
    {id:10, date: '2024-6-15', category: 'プレミアリーグ', title:'アーセナル×ブレントフォード', matchday: '第1節', thumbnail:soccer},
    {id:11, date: '2024-6-15', category: 'プレミアリーグ', title:'ウルブス×エヴァートン', matchday: '第1節', thumbnail:soccer},
    {id:12, date: '2024-6-15', category: 'プレミアリーグ', title:'マンチェスターユナイテッド×マンチェスターシティ', matchday: '第1節', thumbnail:soccer},
    // 追加するときは、ここに追加
