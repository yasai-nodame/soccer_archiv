...
// Algoliaの設定
const ALGOLIA_APP = process.env.VITE_REACT_APP_ALGOLIA_APP; // アプリケーションID
const ALGOLIA_SEARCH =  process.env.VITE_REACT_APP_ALGOLIA_UPLOAD_KEY; //検索用APIキー
const ALGOLIA_INDEX = process.env.VITE_REACT_APP_ALGOLIA_INDEX_NAME; //インデックス名

console.log('algolia_app:', ALGOLIA_APP);
console.log('algolia_search:', ALGOLIA_SEARCH);
console.log('algolia_index_name:', ALGOLIA_INDEX);

const client = algoliasearch(ALGOLIA_APP, ALGOLIA_SEARCH);
