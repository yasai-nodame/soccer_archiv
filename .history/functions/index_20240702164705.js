...
// Algoliaの設定
const ALGOLIA_APP_ID = import.meta.env.VITE_REACT_APP_ALGOLIA_APP_ID; // アプリケーションID
const ALGOLIA_SEARCH_KEY = 'bfcf336d89ab40a0315c7e2340bb6eaa'; //検索用APIキー
const ALGOLIA_INDEX_NAME = 'soccer-archive'; //インデックス名
