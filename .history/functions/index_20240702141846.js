...
// Algoliaの設定
const ALGOLIA_APP_ID = import.meta.env.ALGOLIA_APP_ID; // アプリケーションID
const ALGOLIA_SEARCH_KEY = import.meta.env.ALGOLIA_SEARCH_KEY; //検索用APIキー
const ALGOLIA_INDEX_NAME = import.meta.env.ALGOLIA_INDEX_NAME; //インデックス名
