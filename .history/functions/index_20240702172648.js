...
// Algoliaの設定
const ALGOLIA_APP_ID = REACT_APP_ALGOLIA_APP_ID; // アプリケーションID
const ALGOLIA_SEARCH_KEY = REACT_APP_ALGOLIA_UPLOAD_KEY; //検索用APIキー
const ALGOLIA_INDEX_NAME = REACT_APP_ALGOLIA_INDEX_NAME; //インデックス名
