...
// Algoliaの設定
const ALGOLIA_APP_ID = process.env.VITE_REACT_APP_FIREBASE_ALGOLIA_APP_ID; // アプリケーションID
const ALGOLIA_SEARCH_KEY = process.env.VITE_REACT_APP_FIREBASE_ALGOLIA_SEARCH_KEY; //検索用APIキー
const ALGOLIA_INDEX_NAME = process.env.VITE_REACT_APP_FIREBASE_ALGOLIA_INDEX_NAME; //インデックス名
