...
console.log('algolia_app_id:', process.env.VITE_REACT_APP_FIREBASE_ALGOLIA_APP_ID);
console.log('algolia_search:', process.env.VITE_REACT_APP_FIREBASE_ALGOLIA_UPLOAD_KEY);
console.log('algolia_index_name:', process.env.VITE_REACT_APP_FIREBASE_ALGOLIA_INDEX_NAME);
