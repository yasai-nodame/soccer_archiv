...
// Algoliaの設定
const ALGOLIA_APP_ID = VITE_REACT_APP_ALGOLIA_APP_ID; // アプリケーションID
const ALGOLIA_SEARCH_KEY = VITE_REACT_APP_ALGOLIA_UPLOAD_KEY; //検索用APIキー
const ALGOLIA_INDEX_NAME = VITE_REACT_APP_ALGOLIA_INDEX_NAME; //インデックス名
