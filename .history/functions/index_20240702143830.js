...
const ALGOLIA_APP = process.env.VITE_REACT_APP_ALGOLIA_APP_ID;
const ALGOLIA_SEARCH = process.env.VITE_REACT_APP_ALGOLIA_SEARCH_KEY;
const ALGOLIA_INDEX = process.env.VITE_REACT_APP_ALGOLIA_INDEX_NAME;
const a = dotenv(ALGOLIA_APP,ALGOLIA_SEARCH,ALGOLIA_INDEX);
console.log('a:', a);
console.log('algolia_app_id:', process.env.ALGOLIA_APP);
console.log('algolia_search:', process.env.ALGOLIA_SEARCH);
console.log('algolia_index_name:', process.env.ALGOLIA_INDEX);
